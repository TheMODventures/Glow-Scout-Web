  ...
  return (
    <div className='login-bod w-full h-full flex flex-row items-center justify-center min-h-screen'>
      ...
      <div className='logo-right w-1/2 p-5 bg-white rounded'>
        <div className='py-10 reset-Pasword'>
          ...
          <div className='flex flex-col items-center justify-center'>
            <div className='border-bottom-custom  w-3/5 p-2 flex items-center mb-10'>
              <input type="email" name="email" placeholder='Enter New Password' className='bg-white outline-none text-sm' />
            </div>
            <div className='border-bottom-custom  w-3/5 p-2 flex items-center mb-10'>
              <input type="email" name="email" placeholder='Confirm New Password' className='bg-white outline-none text-sm' />
            </div>
